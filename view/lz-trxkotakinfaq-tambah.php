...
?>
  ...
  <title>LazisLite | Transaksi Kotak Infaq Baru</title>
        ...
        <section class="col-lg-12 connectedSortable">
          ...
          <div class="nav-tabs-custom">
            ...
            <ul class="nav nav-tabs pull-right">
              <li class="pull-left header"><i class="fa fa-inbox"></i> Masukkan data Kotak Infaq berikut</li>
            </ul>
                ...
                <div class="box box-info">
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="number" class="form-control pull-right" id="jumlahkotakinfaq" placeholder = "misal 100000">
                            </div>
                        </div>
