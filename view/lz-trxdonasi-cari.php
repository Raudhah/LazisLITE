        ...
        <section class="col-lg-12 connectedSortable">
          ...
          <div class="nav-tabs-custom">
            ...
            <ul class="nav nav-tabs pull-right">
              <li class="pull-left header"><i class="fa fa-inbox"></i> Cari Transaksi Donasi berdasarkan Kriteria berikut</li>
            </ul>
                ...
                <div class="box box-info">
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <div class="input-group date">
                                    ...
                                    <input type="text" class="form-control" id="tanggaltransaksiantara">
                                </div>
                                <!-- /.input group date -->    
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <select id="inputamil" multiple class="form-control input-lg" row="5">
