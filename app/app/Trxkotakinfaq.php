...
namespace App;
//surprisingly this class is almost indetical to ibrankasku
//I sugest what differ to come is in the controller, where variable named are different

use Illuminate\Database\Eloquent\Model;
use Carbon\Carbon;

class Trxkotakinfaq extends Model
{
    protected $table = 'trxkotakinfaq';

    protected $fillable = ['donatur_id', 'amil_id', 'peruntukandonasi_id', 'tanggaldonasi', 'keterangan', 'jumlahtotal'];
