...
<!-- //========== SITE TITLE ======== -->
@section('pagename', 'Edit Transaksi Donasi')
...
<!-- //===========BOX  HEADER =========== -->
@section('boxheader-title', 'Edit Transaksi Donasi')
...
<!-- form start -->
<form class="form-horizontal" method="POST" action="{{url('')}}/trxdonasi/{{$data->id}}">
{{@csrf_field()}}
