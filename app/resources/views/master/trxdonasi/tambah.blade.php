...
<!-- //========== SITE TITLE ======== -->
@section('pagename', 'Tambah Donasi')
...
<!-- //===========BOX  HEADER =========== -->
@section('boxheader-title', 'Tambah Donasi')
...
<!-- form start -->
<form class="form-horizontal" method="POST" action="{{url('')}}/trxdonasi">
{{@csrf_field()}}
        ...
        <div class="form-group">
            ...
            <label class="input-lg">
                    <input type="radio" name="insidentil" value="0" checked> Donasi Rutin 
                </label>
                <label class="input-lg">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <textarea rows="2" name="keterangan" class="form-control input-lg" id="keterangan" placeholder="Isi dengan keterangan jika ada">{{old('keterangan','')}}</textarea>
            </div>
        </div>
            ...
            <div class="col-sm-10">
                ...
                @foreach($listperuntukandonasi as $peruntukandonasi)   
                    ...
                    <div class="form-group col-sm-12">
                        <label for="detaildonasi{{$peruntukandonasi->id}}" class="col-sm-3 control-label input-lg">
                            {{$peruntukandonasi->namaperuntukandonasi}}
                        </label>
                ...
                @endforeach
                    ...
                    <div class="form-group col-sm-12 ">
                        ...
                        <div class="col-sm-6 ">
                            <input type="number" class=" bg-orange form-control input-lg" id="displayjumlahtotal" name="displayjumlahtotal" disabled value="{{old('jumlahtotal', 0)}}"  placeholder="Jumlah Total">        
                            <input type="hidden" class="form-control input-lg" id="jumlahtotal" name="jumlahtotal" value="{{old('jumlahtotal', 0)}}"  placeholder="Jumlah Total">        
                        </div>
                    </div>
                    <!-- //form-group -->
