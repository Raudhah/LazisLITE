...
<!-- //========== SITE TITLE ======== -->
@section('pagename', 'Cari Transaksi Donasi')
...
<!-- //===========BOX  HEADER =========== -->
@section('boxheader-title', 'Cari Transaksi Donasi berdasarkan Kriteria')
...
{{@csrf_field()}}
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <textarea rows="3" name="keterangan" class="form-control input-lg" id="keterangan" placeholder="Mengandung kata-kata berikut di Keterangan... (misal:untuk ... )">{{old('keterangan')}}</textarea>
            </div>
        </div>
