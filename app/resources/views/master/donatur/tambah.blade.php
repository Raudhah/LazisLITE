...
{{@csrf_field()}}
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <input type="number"  name="nomortelepondonatur"  value="{{old('nomortelepondonatur')}}" class="form-control input-lg" id="nomortelepondonatur" placeholder="08xxxx...">
            </div>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <div class="input-group date">
                    ...
                    <input type="text"  name="tanggallahir" id="tanggallahir" value="{{old('tanggallahir', '17/09/1987')}}"  class="form-control pull-right" >
                </div>
                <!-- //.input group date -->    
            </div>
