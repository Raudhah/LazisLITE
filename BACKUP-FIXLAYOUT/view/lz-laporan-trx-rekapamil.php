...
?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Laporan
        <small>Transaksi per-Amil</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
        <li>Laporan</li>
        <li class="active">Transaksi Per-Amil</li>
      </ol>
    </section>
        ...
        <section class="col-lg-12 connectedSortable">
          ...
          <div class="nav-tabs-custom">
            ...
            <ul class="nav nav-tabs pull-right">
              <li class="pull-left header"><i class="fa fa-inbox"></i> Tampilkan Transaksi per Amil</li>
            </ul>
                ...
                <div class="box box-info">
                    ...
                    <div class="box-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <label class="input-lg">
                                    <input type="radio" name="terambil" checked> Tampilkan Semua
                                </label>
                                <label class="input-lg">
                                    <input type="radio" name="terambil" > yang Sudah Diambil
                                </label>
                                <label class="input-lg">
                                    <input type="radio" name="terambil" > yang Belum Diambil
                                </label>
                            </div>
                        </div>
